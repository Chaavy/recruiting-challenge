...
| JS-005 | Tenant isolation on order lookup and input validation on order creation | bugfix | done | [done/JS-005-tenant-isolation-order-validation.md](done/JS-005-tenant-isolation-order-validation.md) |
| JS-006 | Golden gate: pre-commit hook and regression over JS-004 / JS-005 | bugfix | done | [done/JS-006-golden-gate-precommit.md](done/JS-006-golden-gate-precommit.md) |
| JS-007 | Webhooks slice A: schema, DAL and subscription endpoints | feature | done | [done/JS-007-webhooks-subscriptions.md](done/JS-007-webhooks-subscriptions.md) |
| JS-008 | Webhooks slice B: transactional outbox on order creation | feature | done | [done/JS-008-webhooks-outbox.md](done/JS-008-webhooks-outbox.md) |
